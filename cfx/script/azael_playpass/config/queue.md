...
- allowRetryOnFail: `table<{ [key]: boolean|integer }>`
    ...
    - การเปิดใช้งานฟีเจอร์นี้อาจทำให้การจัดการคิวช้าลง หากเกิดข้อผิดพลาดกับผู้เล่นพร้อมกันเป็นจำนวนมาก แต่จะช่วยให้ผู้เล่นที่พบปัญหาได้รับประสบการณ์ที่ดียิ่งขึ้น
    ...
    - ผู้เล่นควร รีสตาร์ท **FiveM**/**RedM** ก่อนเชื่อมต่อใหม่ เนื่องจาก **FXServer** อาจใช้เวลา **10** ถึง **60** วินาทีในการตัดการเชื่อมต่อเดิม
